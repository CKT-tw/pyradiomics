...
int get_angle_count(int *size, float *distances, int Nd, int n_dist, char bidirectional, int force2Ddim);
int build_angles(int *size, float *distances, int Nd, int n_dist, int force2Ddim, int *Na, int *angles);
