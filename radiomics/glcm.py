...
class RadiomicsGLCM(base.RadiomicsFeaturesBase):
  ...
  def _calculateMatrixNonSimplified(self, voxelCoordinates=None):
    ...
    P_glcm, _ = cMatrices.calculate_glcm(*matrix_args)
  ...
  def getAutocorrelationFeatureValue(self):
    ...
    **1. Autocorrelation**
    ...
    return self.direction_evaluation(ac, 1)
  ...
  def getClusterProminenceFeatureValue(self):
    ...
    **3. Cluster Prominence**
    ...
    return self.direction_evaluation(cp, 1)
  ...
  def getClusterShadeFeatureValue(self):
    ...
    **4. Cluster Shade**
    ...
    return self.direction_evaluation(cs, 1)
  ...
  def getClusterTendencyFeatureValue(self):
    ...
    **5. Cluster Tendency**
    ...
    return self.direction_evaluation(ct, 1)
  ...
  def getContrastFeatureValue(self):
    ...
    **6. Contrast**
    ...
    return self.direction_evaluation(cont, 1)
  ...
  def getCorrelationFeatureValue(self):
    ...
    **7. Correlation**
    ...
    return self.direction_evaluation(corr, (1, 2, 3))
  ...
  def getDifferenceAverageFeatureValue(self):
    ...
    **8. Difference Average**
    ...
    return self.direction_evaluation(diffavg, 1)
  ...
  def getDifferenceEntropyFeatureValue(self):
    ...
    **9. Difference Entropy**
    ...
    return self.direction_evaluation(difent, 1)
  ...
  def getDifferenceVarianceFeatureValue(self):
    ...
    **10. Difference Variance**
    ...
    return self.direction_evaluation(diffvar, 1)
  ...
  def getJointEnergyFeatureValue(self):
    ...
    **11. Joint Energy**
    ...
    return self.direction_evaluation(ene, 1)
  ...
  def getJointEntropyFeatureValue(self):
    ...
    **12. Joint Entropy**
    ...
    return self.direction_evaluation(ent, 1)
  ...
  def getImc1FeatureValue(self):
    ...
    **13. Informational Measure of Correlation (IMC) 1**
    ...
    return self.direction_evaluation(imc1, 1)
  ...
  def getImc2FeatureValue(self):
    ...
    **14. Informational Measure of Correlation (IMC) 2**
    ...
    return self.direction_evaluation(imc2, 1)
  ...
  def getIdmFeatureValue(self):
    ...
    **15. Inverse Difference Moment (IDM)**
    ...
    return self.direction_evaluation(idm, 1)
  ...
  def getMCCFeatureValue(self):
    ...
    **16. Maximal Correlation Coefficient (MCC)**
    ...
    return self.direction_evaluation(MCC, 1).real
  ...
  def getIdmnFeatureValue(self):
    ...
    **17. Inverse Difference Moment Normalized (IDMN)**
    ...
    return self.direction_evaluation(idmn, 1)
  ...
  def getIdFeatureValue(self):
    ...
    **18. Inverse Difference (ID)**
    ...
    return self.direction_evaluation(invDiff, 1)
  ...
  def getIdnFeatureValue(self):
    ...
    **19. Inverse Difference Normalized (IDN)**
    ...
    return self.direction_evaluation(idn, 1)
  ...
  def getInverseVarianceFeatureValue(self):
    ...
    **20. Inverse Variance**
    ...
    return self.direction_evaluation(inv, 1)
  ...
  def getMaximumProbabilityFeatureValue(self):
    ...
    **21. Maximum Probability**
    ...
    return self.direction_evaluation(maxprob, 1)
  ...
  def getSumAverageFeatureValue(self):
    ...
    **22. Sum Average**
    ...
    return self.direction_evaluation(sumavg, 1)
  ...
  def getSumEntropyFeatureValue(self):
    ...
    **23. Sum Entropy**
    ...
    return self.direction_evaluation(sumentr, 1)
  ...
  def getSumSquaresFeatureValue(self):
    ...
    **24. Sum of Squares**
    ...
    return self.direction_evaluation(ss, 1)


class RadiomicsGLCMfromMatrix(RadiomicsGLCM):
  def __init__(self, P_glcm, **kwargs):
  ...
  def _calculateCoefficients(self):
    self.logger.debug('Calculating GLCM coefficients by given matrix')

    # Coefficients in base.py: grayLevels, Ng
    self.coefficients['grayLevels'] = numpy.where(numpy.sum(self.P_glcm, axis=(0, 2, 3))!=0)[0] + 1 # Start from grayscale 1, 0 is background
    self.coefficients['Ng'] = self.P_glcm.shape[1]  # max gray level in the ROI
    ...
    self.P_glcm = numpy.delete(self.P_glcm, emptyGrayLevels - 1, 1)
    self.P_glcm = numpy.delete(self.P_glcm, emptyGrayLevels - 1, 2)
    ...
    if self.symmetricalGLCM:
      ...
      # Transpose and copy GLCM and add it to P_glcm. Numpy.transpose returns a view if possible, use .copy() to ensure
      # a copy of the array is used and not just a view (otherwise erroneous additions can occur)
      self.P_glcm += numpy.transpose(self.P_glcm, (0, 2, 1, 3)).copy()

    sumP_glcm = numpy.sum(self.P_glcm, (1, 2))

    # Delete empty angles if no weighting is applied
    if self.P_glcm.shape[3] > 1:
      emptyAngles = numpy.where(numpy.sum(sumP_glcm, 0) == 0)
      if len(emptyAngles[0]) > 0:  # One or more angles are 'empty'
        self.P_glcm = numpy.delete(self.P_glcm, emptyAngles, 3)
        sumP_glcm = numpy.delete(sumP_glcm, emptyAngles, 1)
      else:
        self.logger.debug('No empty angles')
    ...
    sumP_glcm[sumP_glcm == 0] = numpy.nan
    # Normalize each glcm
    self.P_glcm /= sumP_glcm[:, None, None, :]
